 ...
 * This is an adjusted copy from the proxy-vole project:
 ...
 ***************************************************************************
 */
public class HttpPacScriptMethods {

	private static final Logger logger = (Logger) LoggerFactory.getLogger(HttpPacScriptMethods.class.getName());
	...
	public static String preparePacScript(String pacScript) {
		...
		String classname = HttpPacScriptMethods.class.getSimpleName();
		
		for(Method method : HttpPacScriptMethods.class.getMethods()) {
	...
	public boolean isResolvable(String host) {
		try {
			...
			logger.trace("Hostname not resolveable: "+host);
		}
		return false;
	}
	...
	public String dnsResolve(String host) {
		try {
			...
			logger.trace("DNS not resolveable: "+host);
		}
		return "";
	}
...
//							.finest("Local address resolved to: "+adr);
			...
			logger.trace("Local address not resolvable.");
			return "";
		}
	}
	...
	public String dnsResolveEx(String host) {
		...
		try {
			...
			logger.trace("DNS name not resolvable: "+host);
		}
	...
	public String sortIpAddressList(String ipAddressList) {
		...
		try {
			...
			logger.trace("Cannot sort invalid IP list: "+ipAddressList);
			return "";
		}
	}
